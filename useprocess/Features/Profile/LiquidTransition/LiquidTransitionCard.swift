...
/// Composant LiquidTransition — copie fidèle de Home.swift, placé en bas du profil.
struct LiquidTransitionCard: View {
    ...
    var body: some View {
        LiquidCard(
            ...
            subTitle: "see-yohn",
            detail: "An armchair",
            description: "Mi papa compro un sillon y una mesa de centro para la sala."
        ) {
            ...
            DispatchQueue.main.asyncAfter(deadline: .now() + (expandCard ? 0 : 0.2)) {
                ...
                topLiquidView.play(fromProgress: expandCard ? 0 : 0.45, toProgress: expandCard ? 0.6 : 0) { _ in
                    isfinished = false
                }
            }
            // Toggle Card
        ...
        .frame(height: expandCard ? 620 : 480)
    }
    ...
    func LiquidCard(
        ...
        detail: String,
        description: String,
        color: SwiftUI.Color = Color("LiquidTransitionBlue"),
