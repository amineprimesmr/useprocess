...
export function IconClockOutline({ className }) {
  return (
    <svg
      className={className}
      width="28"
...
export function IconGlobeOutline({ className }) {
  return (
    <svg
      className={className}
      width="28"
...
export function IconMaterialImage({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconMaterialMovie({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
...
export function IconMaterialLightbulb({ className }) {
  return (
    <svg
      className={className}
      viewBox="0 0 24 24"
