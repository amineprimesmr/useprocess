...
exports.recordAffiliateTrialStart = recordAffiliateTrialStart;
 ...
 */
async function recordAffiliateTrialStart(params) {
    if (!(0, revenueCat_1.isTrialStartEvent)(params.event)) {
    ...
    return db().runTransaction(async (transaction) => {
        ...
        if (attrData.trialStartedAt)
            return { recorded: false, skipped: "DUPLICATE" };
        const now = admin.firestore.Timestamp.now();
        transaction.set(attributionRef, {
            trialStartedAt: now,
